...
impl Compiler {
    ...
    fn compile_generic_for(
        ...
        */
        ...
        self.chunk.patch_operand(
            pattern_success_jump,
            pattern_success as u32,
        );
